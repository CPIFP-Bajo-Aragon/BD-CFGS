DELIMITER $$
DROP  PROCEDURE `ALTA_DATOS`$$
CREATE  PROCEDURE `ALTA_DATOS`(out mensaje varchar(50))
BEGIN
...
begin	
    set mensaje='El procedimiento ejecuta rollback';
end;
...
INSERT INTO  gastos  ( idgastos,idRESERVA  , idSERVICIOS  ,Fecha ,Cantidad ,Precio) VALUES (1,8,1, '2009-03-15 12:00', 1,10);
INSERT INTO  gastos  ( idgastos,idRESERVA  , idSERVICIOS  ,Fecha ,Cantidad ,Precio) VALUES (2, 9,1,  '2009-03-15 11:00', 1,10);
INSERT INTO  gastos  (idgastos, idRESERVA  , idSERVICIOS  ,Fecha ,Cantidad ,Precio) VALUES (3, 10, 2, '2009-03-15 09:30', 1,2);
else 
    ...
    set mensaje='El procedimiento ejecutado correctamente';
END$$
DELIMITER ;
