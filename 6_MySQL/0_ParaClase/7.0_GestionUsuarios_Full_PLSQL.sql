...
DELIMITER $$
CREATE PROCEDURE ALTA_USUARIO (IN PAR1 VARCHAR(25), IN PAR2 VARCHAR (25))
BEGIN
    ...
    IF EXISTE=0 THEN 
		SELECT IFNULL(MAX(ID),0) INTO NEW_ID FROM USUARIOS;
		SET NEW_ID= NEW_ID+1;
...
CALL ALTA_USUARIO('usuario 1', 'pass 1');
CALL ALTA_USUARIO('usuario 2', 'pass 2');
CALL ALTA_USUARIO('usuario 3', 'pass 3');
CALL ALTA_USUARIO('usuario 4', 'pass 4');
CALL ALTA_USUARIO('usuario 5', 'pass 5');
CALL ALTA_USUARIO('usuario 6', 'pass 6');
...
/******** PROCEDIMIENTOS CON VALORES DE ENTRADA Y SALIDA *****************/
USE CLASE1;
...
/*     CREACION DE FUNCIONES Y MODIFICACION DEL PROCEDIMIENTO EXISTENTE */
